        ...
        <section className="mb-8 grid gap-6 rounded-[2rem] border border-slate-200 bg-white/85 p-8 shadow-[0_30px_70px_-45px_rgba(15,23,42,0.55)] backdrop-blur lg:grid-cols-[1.2fr_0.8fr]">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600">
              Generate local Terraform variables, run a plan, review a redacted payload, and only
              then unlock the apply path for the GTM server environment.
            </p>
          </div>
          <div className="rounded-[1.75rem] border border-slate-900 bg-slate-950 p-6 text-slate-100">
            ...
            <ol className="mt-4 space-y-4 text-sm leading-6 text-slate-300">
              <li>1. Validate project, runtime, and GTM bootstrap input.</li>
              <li>2. Produce a redacted review summary before any apply action is exposed.</li>
              <li>3. POST to /api/deploy/plan and unlock apply only after success.</li>
            </ol>
          </div>
        </section>
