  ...
  return (
    <div className="rounded-[1.75rem] border border-red-200 bg-red-50/90 p-5 shadow-[0_18px_40px_-34px_rgba(127,29,29,0.6)]">
      ...
      <p className="mt-2 text-sm leading-6 text-red-900/80">
        Run <code className="rounded bg-red-100 px-1 py-0.5 text-xs">terraform destroy</code>{" "}
        against the local workspace.
      </p>
      <label
        className="mt-4 flex items-start gap-3 text-sm text-red-950"
        htmlFor="destroy-confirmation"
      >
        <Checkbox
      ...
      {error ? (
        <div
          className="mt-3 rounded-xl border border-red-200 bg-white/80 px-3 py-2 text-sm text-red-800"
          role="alert"
        >
